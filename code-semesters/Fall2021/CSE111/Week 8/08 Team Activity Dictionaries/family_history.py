...
def print_death_age(people_dict):
    ...
    for person_key, value in people_dict.items():
...
def count_genders(people_dict):
    ...
    num_ppl = len(people_dict)
    female_count = num_ppl - male_count
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        print(f"Husband Name and Age: {husband_name}, {husband_age}")
        print(f"Wedding Year: {wedding_year}")
        print(f"Wife Name and Age: {wife_name}, {wife_age}")
        
        #print(f"Name of husband: {husband_name}")
        #print(f"")
        #print(f"Name of husband: {wife_name}")
