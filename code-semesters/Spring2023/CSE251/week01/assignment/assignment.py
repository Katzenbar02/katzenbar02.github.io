...
# Thread functions for shapes

def trea_draw_squares(tur, lock):
    """Draw a group of squares"""
        #lock it
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
...
def trea_draw_circles(tur, lock):
    """Draw a group of circles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock:
...
def trea_draw_triangles(tur, lock):
    """Draw a group of triangles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock:
...
def trea_draw_rectangles(tur, lock):
    """Draw a group of Rectangles"""
    for x in range(-300, 350, 200):
        for y in range(-300, 350, 200):
            with lock:
...
def run_with_threads(tur, log, main_turtle):
    ...
    thread1 = threading.Thread(target=trea_draw_squares, args=(tur, lock))
    thread2 = threading.Thread(target=trea_draw_circles, args=(tur, lock))
    thread3 = threading.Thread(target=trea_draw_triangles, args=(tur, lock))
    thread4 = threading.Thread(target=trea_draw_rectangles, args=(tur, lock))
