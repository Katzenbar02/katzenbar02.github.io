...
dwellings_table = (
    ...
    .filter(['yrbuilt', 'sprice_avg', 'stories_avg', 'nocars_avg', 'livearea_avg', 'numbdrm_avg', 'numbaths_avg'])
    .reset_index()
)

# %%Print dwellings_table
dwellings_table
...
overlay
#%% Create the first chart: Average Selling Price of a House each Year
chart1 = (
...
final_chart1.save('AvgSellingPriceEachYear.svg')
