...
class LinkedList:
    ...
    def insert_tail(self, value):
        ...
        linked list. Implement the insert_tail function in the LinkedList class.
        The function should add a new node (LinkedList.Node) at the end of the linked list.
        You will need to write code to test your solution.
        Hint: Consider the code already written for insert_head.
        """
        new_node = LinkedList.Node(value)
        if self.head is None:
            self.head = new_node
    ...
    def remove_tail(self):
        ...
        Implement the remove_tail function in the LinkedList class.
          The function should remove the last node. You will need to write code to test your solution. 
          Hint: Consider the code already written for remove_head.
        """
        if self.head == self.tail:
            self.head = None
            self.tail = None
    ...
    def remove(self, value):
        """
        Remove the first node that contains 'value'.Implement the remove function in the LinkedList class. 
        The function will need to search for the node (starting at the head) that contains the value and then remove that one node. 
        The function should not continue searching the list once a match has been found and the node has been deleted. 
        You will need to write code to test your solution. Hint: You may be able to reuse the remove_head and remove_tail functions.
        """
        curr = self.head
        while curr is not None:
            if curr.data == value:
    ...
    def replace(self, old_value, new_value):
        ...
        to 'new_value'.Implement the replace function in the LinkedList class. 
        The function should search for all nodes that are equal to 'old_value' and then replace the value in those nodes with 'new_value'. 
        Unlike the remove function, this function should continue searching through the list to replace all values that match 'old_value'. 
        You will need to write code to test your solution.
        """
        curr = self.head
        while curr is not None:
